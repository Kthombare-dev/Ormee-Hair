    ...
    <div className="w-full">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-md">
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          ...
          <Link
            href="/consultation"
            className="px-5 py-2 rounded-lg bg-primary text-white font-semibold shadow-md hover:scale-105 transition"
          >
            Book Now
          </Link>
        </div>
      ...
      <section className="relative w-full h-[550px] rounded-b-3xl overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent flex flex-col items-start justify-center px-10 md:px-20">
          ...
          <Link
            href="#form"
            className="px-6 py-3 bg-primary text-white rounded-lg font-semibold shadow-lg hover:scale-105 transition"
          >
            ...
            {!submitted ? (
              <>
                ...
                <form className="space-y-5 text-left" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full h-12 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 hover:scale-[1.02] transition transform shadow-md"
                  >
