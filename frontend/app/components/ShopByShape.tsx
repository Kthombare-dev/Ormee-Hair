      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mt-6">
          <div className="bg-gradient-to-b from-white to-secondary/20 shadow-md rounded-2xl p-9 max-w-2xl mx-auto">
            ...
            <button
              onClick={() => router.push("/consultation")} // 👈 redirects
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border border-primary/60 bg-white text-primary font-semibold hover:bg-primary hover:text-white hover:shadow-lg hover:scale-105 h-12 px-6 text-base"
            >
