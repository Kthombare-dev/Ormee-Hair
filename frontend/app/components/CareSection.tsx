      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className="relative w-full max-w-3xl h-[400px] lg:h-[500px] rounded-3xl overflow-hidden shadow-lg">
            <Image
              src="/hair-care-products.jpg" // ✅ Ensure this image is in /public
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-4">
                  <button className="px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold shadow hover:shadow-lg transition">
                    Book Consultation
                  </button>
